        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: '058fc130-145b-4f73-83d5-e5d5a04dfecd',
                name: data.name || '',
                email: data.email || '',
            ...
            if (response.ok) {
              ...
              console.error('❌ Zappy: API returned error status', response.status);
            }
          } catch (error) {
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "UVC-Smart uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
